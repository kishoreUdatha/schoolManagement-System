    ...
    <>
      <div className="public-page">
        <header className="public-header">
          ...
          <nav>
            <Link href="/dashboard/school-admin-dashboard">School operations</Link>
            <Link href="/dashboard/teacher-dashboard">Teaching</Link>
            <Link href="/dashboard/student-dashboard">Student life</Link>
          </nav>
          <Link href="/welcome/sign-in" className="btn primary">Sign in</Link>
        </header>
        <main className="landing">
          <div>
            ...
            <div className="actions">
              ...
              <Link href="/dashboard/school-admin-dashboard" className="btn">View school dashboard</Link>
            </div>
            <div className="gap" />
