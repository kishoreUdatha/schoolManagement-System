...
// Wired: GET /api/v1/parent/auth/me, children from GET /api/v1/parent/me/children (ParentShell),
// POST /api/v1/parent/me/requests/contact-change, GET /api/v1/parent/me/requests?kind=contact_change, POST /requests/{id}/cancel. Hand-maintained.
