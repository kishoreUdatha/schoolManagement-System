...
// Wired: GET /api/v1/parent/me/children/{id}/profile, …/homework, …/fees, …/transport, GET /api/v1/parent/me/ptm, GET /api/v1/branding/me. Hand-maintained.
// Not wired: "At school · Checked in" and the live bus ETA — no endpoint.
