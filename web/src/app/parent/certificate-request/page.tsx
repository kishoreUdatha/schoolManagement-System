...
// Wired: GET /api/v1/parent/me/children/{id}/certificates/available, GET/POST /api/v1/parent/me/children/{id}/certificates, GET …/certificates/{cert}/pdf; the request carries delivery_preference. Hand-maintained.
