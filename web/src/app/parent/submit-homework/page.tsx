...
// Wired: GET /api/v1/parent/me/children/{id}/homework, GET + POST …/homework/{homework_id}/submission ({attachment_url, comment}; POST creates or replaces). Hand-maintained.
