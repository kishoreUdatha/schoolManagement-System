...
// Wired: GET /api/v1/parent/me/children/{id}/payments (?order=), GET /api/v1/parent/me/children/{id}/payments/{order}/receipt.pdf (api.open / api.download). Hand-maintained.
