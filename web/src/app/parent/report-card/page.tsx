...
// Wired: GET /api/v1/parent/me/children/{id}/exams/{exam_id} (?exam=, else latest from GET /api/v1/parent/me/children/{id}/exams), GET …/report-card.pdf (api.download), POST …/exams/{exam_id}/acknowledge; school name/logo from the result. Hand-maintained.
