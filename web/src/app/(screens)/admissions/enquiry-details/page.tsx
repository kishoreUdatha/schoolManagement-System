...
// Wired: GET /api/v1/school/admissions/enquiries/{id} (?id=); POST /enquiries/{id}/stage, /activities, /convert; DELETE /enquiries/{id}; GET /api/v1/school/admissions/applications. Hand-maintained.
