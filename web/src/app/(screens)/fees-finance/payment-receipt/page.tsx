...
// Wired: GET /api/v1/parent/me/children/{id}/payments (+ /{order}/receipt.pdf), /school/payments/online (+ /{order}/receipt.pdf), /school/accounts/collections/{id} (?child=&order= or ?receipt=). Hand-maintained.
