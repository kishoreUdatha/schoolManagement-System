...
// Wired: GET/POST /api/v1/school/accounts/concessions, PATCH /concessions/{id}, POST /concessions/{id}/end, GET /fees/heads, /directory/students. Hand-maintained.
...
export default function Page() {
  // Not wired: "Approve concession" — the API has no request/approval step; a concession applies when saved (form in the aside).
  return (
