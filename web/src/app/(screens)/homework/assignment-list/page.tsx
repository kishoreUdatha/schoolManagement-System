...
// Wired: GET /api/v1/teacher/projects, /teacher/projects/{id}/progress, /teacher/my-classes; PATCH/DELETE /teacher/projects/{id};
// project milestones GET/POST /api/v1/school/parent-services/projects/{id}/milestones, DELETE /milestones/{mid}. Hand-maintained.
