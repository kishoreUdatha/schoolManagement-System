...
// Wired: POST /api/v1/school/exams, GET/PATCH/DELETE /school/exams/{id} (?id=), POST /school/exams/{id}/papers, PATCH/DELETE /school/exams/papers/{id}, GET /school/exam-types, /academic-years, /academic-years/{id}/terms, /classes, /classes/{id}/subjects. Hand-maintained.
