...
// Wired: GET /api/v1/super-admin/usage/summary, usage/renewals?within_days=30, POST usage/renewals/send?within_days=30, health, tickets, tenants?page_size=3. Hand-maintained.
