...
// Wired: GET /api/v1/super-admin/tenants/{id} (?id=), tenants/{id}/usage, tenants/{id}/payments, tenants/{id}/subscription, plans; PATCH tenants/{id}, PATCH tenants/{id}/status, POST tenants/{id}/subscription, POST tenants/{id}/payments. Hand-maintained.
