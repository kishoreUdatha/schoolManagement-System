...
// Wired: POST /api/v1/school/health/visits; GET /health/visits?on=, PATCH/DELETE /health/visits/{id},/health/students/{id} (allergy check), /students (search). Hand-maintained.
