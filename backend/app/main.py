...
app.include_router(
    ...
    prefix="/api/v1/school/analytics",
    tags=["school / reports / analytics"],
)
app.include_router(
...
app.include_router(
    school_result_overrides.router,
    prefix="/api/v1/school/result-decisions",
    tags=["school / result decisions"],
)
