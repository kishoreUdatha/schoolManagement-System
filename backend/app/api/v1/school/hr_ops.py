...
def list_requisitions(user: SchoolAdminOrPrincipal, db: Db,
...
def create_requisition(payload: RequisitionIn, user: SchoolAdminOrPrincipal, db: Db):
...
def submit(requisition_id: int, user: SchoolAdminOrPrincipal, db: Db):
...
def set_status(requisition_id: int, payload: StatusIn, user: SchoolAdminUser, db: Db):
...
def start(staff_id: int, payload: StartChecklistIn, user: SchoolAdminUser, db: Db):
...
def add_task(staff_id: int, payload: TaskIn, user: SchoolAdminUser, db: Db):
...
def set_task(task_id: int, payload: TaskSetIn, user: SchoolAdminUser, db: Db):
