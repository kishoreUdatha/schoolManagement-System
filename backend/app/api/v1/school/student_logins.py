...
from app.core.deps import StudentRecords
...
def status_list(current_user: StudentRecords, db: Db, class_id: Optional[int] = None):
...
def create_for_class(class_id: int, current_user: StudentRecords, db: Db):
...
def create_one(student_id: int, current_user: StudentRecords, db: Db):
...
def revoke(student_id: int, current_user: StudentRecords, db: Db):
