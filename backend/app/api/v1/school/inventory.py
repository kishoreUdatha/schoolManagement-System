...
def dashboard(current_user: Actor, db: Db):
...
def update_supplier(supplier_id: int, payload: SupplierIn, current_user: Actor, db: Db):
...
def create_item(payload: ItemIn, current_user: Actor, db: Db):
...
def update_item(item_id: int, payload: ItemIn, current_user: Actor, db: Db):
...
def moves(current_user: Actor, db: Db, item_id: Optional[int] = Query(None), days: int = Query(90, ge=1, le=730)):
...
def record_move(payload: StockMoveIn, current_user: Actor, db: Db):
...
def get_asset(asset_id: int, current_user: Actor, db: Db):
...
def update_asset(asset_id: int, payload: AssetUpdate, current_user: Actor, db: Db):
...
def asset_event(asset_id: int, payload: AssetEventIn, current_user: Actor, db: Db):
...
def sales(current_user: Actor, db: Db, on: Optional[date] = Query(None), student_id: Optional[int] = Query(None)):
...
def sell(payload: SaleIn, current_user: Actor, db: Db):
...
def void(sale_id: int, current_user: Actor, db: Db):
