...
MAP = {
    ...
    "students": {
        **crud("GET /school/students", "POST /school/students; POST /school/students/bulk", "GET /school/students/{id}",
        ...
        "transfer": (D, "POST /school/students/{id}/transfer", "Closes the enrolment as left, on the day they left"),
    ...
    "exams": {
        **crud("GET /school/exams", "POST /school/exams", "GET /school/exams/{id}", "PATCH /school/exams/{id}"),
        ...
        "open-marks": (D, "POST /school/exams/{id}/marks-window", "Open or close marks entry"),
    ...
    "mark_entries": {
        **crud("GET /teacher/marks/papers/{id}", "POST /teacher/marks/papers/{id}/save", "GET /teacher/marks/papers/{id}",
        ...
        "verify": (D, "POST /school/exams/papers/{id}/verify", "Signed off by someone other than whoever entered them"),
    },
    ...
    "results": {
        **crud((D, "GET /parent/me/children/{id}/exams/{exam_id}", "Computed from marks"),
        ...
        "revise": (D, "POST /school/exams/{id}/revise", "Takes it back with a reason and a revision number"),
    },
    ...
    "payments": {
        **crud("GET /school/accounts/collections; GET /school/payments/online", "POST /school/fees/student-fees/{id}/record-payment",
        ...
        "reconcile": (D, "GET /school/payments/reconciliation", "Orders against the fees they settled"),
    },
    ...
    "hostel_allocations": {
        **crud("GET /school/hostels/{id}/residents", "POST /school/hostels/allocations", None,
        ...
        "transfer": (D, "POST /school/hostels/allocations/{id}/transfer", "One act, so the history has no gap"),
    ...
    "visits": {
        **crud("GET /school/front-desk/visits", "POST /school/front-desk/visits", None,
        ...
        "approve": (D, "POST /school/front-desk/visits/{id}/host-decision", "The host confirms or declines"),
...
EXTRA = [
    ("Examinations & Results", "exams", "Action", "POST", "/school/exams/{id}/marks-window", "Close marks entry when everything is in, or open it again", "School Admin"),
    ("Examinations & Results", "mark_entries", "Action", "POST", "/school/exams/papers/{id}/verify", "Sign off a paper's marks; cleared if the marks then change", "School Admin, Principal"),
    ("Student Lifecycle", "students", "Action", "GET", "/school/students/{id}/enrollments", "Where a child sat each year, and how it ended", "School Admin"),
